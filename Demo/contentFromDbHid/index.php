...
<?php
ob_start();
setOption("options/hide_untranslated", true);
    ...
    <div class="container">
        <div class="no-overflow" style="padding-top: 40px">
            ...
            <p class="text-light" style="margin-top: 10px; padding: 0 20px">
                <?php __("the  Article Number <strong> <span class='fg-red'>4</span> Not Translated in English and Spain</strong> So Try Choice English or Spain Language , The Article Number <strong>4</strong> well be Hide!") ?>
            </p>
            <p class="text-light" style="margin-top: 10px; padding: 0 50px">   
                <?php __("the  Article Number <strong> <span class='fg-red'>2</span> Not Translated in Arabic</strong> So Try Choice Arabic Language , The Article Number <strong>2</strong> well be Hide!") ?>
            </p>
            <p class="text-light" style="margin-top: 10px; padding: 0 50px">
